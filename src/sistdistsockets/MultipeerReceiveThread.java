...
/**
 * A classe MultipeerReceiveThread é responsável por ficar constantemente
 * recebendo as mensagens que chegam para o grupo Multicast, e processá-las para
 * um determinado peer invocando uma instância da classe
...
public class MultipeerReceiveThread extends Thread {
     ...
     * processos.<p>
     * Esse método instancia um objeto da classe MulticastSocket, recebe as
     * mensagens enviadas ao grupo Multicast e inicializa um objeto da classe
     * MultipeerMessageManager para processar a mensagem recebida.</p>
     */
    @Override
    public void run() {
        try {
